package org.dmetzler.serverless.movie.jersey;
 ...
 * <code>AwsProxyResponse</code> object. The response object is passed in the constructor alongside an
 * <code>ExceptionHandler</code> instance.
 */
class JerseyServletResponseWriter implements ContainerResponseWriter {
     ...
     */
    @SuppressFBWarnings("HTTP_RESPONSE_SPLITTING") // suppress this because headers are sanitized in the setHeader
                                                   // method of the servlet response
